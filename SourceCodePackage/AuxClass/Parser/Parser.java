...
*************************************************------------------------------------------------*******************************-------------------------------
    ...
    public String get(Reader fileIn, int NumberLine, char forNumberLine_CharLimit int CompletelyLine) throws IOException;// This method is used to obtain the line number from the input file(internal method)
...
//--------------------------------------------------------------
public String get(Reader fileIn, int NumberLine,char forNumberLine_CharLimit, int CompletelyLine) throws IOException {
    ...
    // Read characters until a space is found. It is assumed that the line number is separated by a space
     if(NumberLine != 0){
        while ((c = fileIn.read()) != -1 && c != forNumberLine_CharLimit) {
        result.append((char) c);
     }
     //Consume the space
     //Consumir el espacio
     if((char)c == forNumberLine_CharLimit){
